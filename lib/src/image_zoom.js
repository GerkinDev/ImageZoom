...
(function(){
	...
	ImageZoom = function(selector, options){
		 ...
		 * @memberof ImageZoom
		 * @summary Reposition elements after changes after absolute positionning changes
		 * @description Reposition zoomed images relative to first relative scope (IE TODO). This function SHOULD be called after every function that is able to change the window size. Also, it is automatically bind to the {&link window.onresize resize event}.
		 ...
		 * @description uUnbind all events to the object, setting ImageZoom in a "sleeep" status.
		 * @returns {this} This object for chained calls
		 * @public
		 * @instance
		 * @since 0.1.0
		 ...
		 * @memberof ImageZoom
		 * @summary Recalculate everything
		 * @description Recalculate every proportions, offsets, opaoity, etc etc. This function is auto called by the object itself on required events. Call this functon if ImageZoom behave in an anormal way if a particular context.
		 ...
		 * @function delete
		 * @memberof ImageZoom
		 * @summary Delete all items related to ImageZoom instance
		 * @description Remove everything linked & created by ImageZoom. It shoudl allow garbage collectors to totally remove the ImageZoom from memory if you set the var(s) pointing to ImageZoom instance to a non ImageZoom instance
